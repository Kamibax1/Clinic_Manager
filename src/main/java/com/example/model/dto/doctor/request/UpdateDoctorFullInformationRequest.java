...
public class UpdateDoctorFullInformationRequest {
    @Getter @Setter
    ...
    public UpdateDoctorFullInformationRequest() {
    }

    public UpdateDoctorFullInformationRequest(String firstName, String lastName, String middleName, String phoneNumber) {
